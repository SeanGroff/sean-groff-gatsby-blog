...
description: 'If you do not understand how a reducer function works you will likely always reach for useState. This is not the worst thing in the world, but I hope after reading this article you will understand exactly how to implement useReducer and have a decent idea when to use useReducer'
date: '2019-05-20'
categories: react
type: 'garden'
